                ...
                {items.map((target) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={!!selecting}
                      className="w-full flex items-center gap-3 px-3 py-2 rounded-lg border border-border hover:border-brand-300 hover:bg-brand-50/50 transition-colors text-left cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
