    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex items-center gap-3 p-4 bg-surface rounded-lg">
          ...
          />
          <div>
            <div className="text-sm font-medium text-foreground">{aiName || 'AgentDock'}</div>
      ...
      <div>
        ...
        <Input
          ...
          className="max-w-xs"
        />
        <p className="text-xs text-muted-foreground mt-1">工作台默认显示的 AI 助手名称，当前 operator 可在个人资料里单独覆盖</p>
      </div>
