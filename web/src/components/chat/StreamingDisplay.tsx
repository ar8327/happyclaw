        ...
        <div className="mb-3 rounded-xl border border-warning-border/60 bg-warning-bg/40 overflow-hidden">
          ...
          >
            ...
            {streaming.isThinking && (
              <span className="flex gap-0.5 ml-0.5">
                <span className="w-1 h-1 bg-warning rounded-full animate-bounce [animation-delay:-0.3s]" />
                <span className="w-1 h-1 bg-warning rounded-full animate-bounce [animation-delay:-0.15s]" />
                <span className="w-1 h-1 bg-warning rounded-full animate-bounce" />
              </span>
            )}
          ...
          {thinkingExpanded && (
            <div
              ...
              className="px-3 pb-3 text-sm text-warning-foreground/70 whitespace-pre-wrap break-words max-h-64 overflow-y-auto border-t border-warning-border"
            >
              {streaming.thinkingText}
            </div>
          )}
