      ...
      >
        ...
        {uploading && uploadProgress ? (
          ...
          <div className="space-y-2">
            ...
            <p className="text-[11px] text-muted-foreground/80 text-center">{progressPercent}%</p>
          </div>
        ) : (
          /* Idle state */
          <div className="flex flex-col items-center gap-2 text-center py-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-foreground bg-surface-2 hover:bg-surface-3 rounded-md transition-colors cursor-pointer"
              >
