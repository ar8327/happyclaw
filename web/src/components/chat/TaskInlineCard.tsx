      ...
      <button
        ...
        className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg border transition-colors text-left ${
          isRunning
            ...
            : status === 'completed'
              ? 'border-success-border bg-success-bg/50 hover:bg-success-bg'
              : 'border-error-border bg-error-bg/50 hover:bg-error-bg'
        }`}
      >
        {statusIcon}
        ...
        <span className="text-[11px] text-muted-foreground/80 flex-shrink-0 tabular-nums">
      ...
      {expanded && hasContent && streaming && (
        ...
        >
          <div className="px-3 py-2 space-y-2">
            {/* Thinking / Reasoning */}
            {streaming.thinkingText && (
              <div className="rounded-md border border-warning-border/60 bg-warning-bg/40 px-2.5 py-2">
                <div className="text-[11px] font-medium text-warning mb-1 flex items-center gap-1">
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" />
                  </svg>
                  Reasoning
                </div>
                <div className="text-xs text-warning-foreground/70 whitespace-pre-wrap break-words max-h-32 overflow-y-auto">
