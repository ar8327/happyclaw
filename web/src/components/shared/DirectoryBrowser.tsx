          ...
          {currentPath && (
            <div className="flex items-center justify-between px-3 py-2 bg-muted border-b border-border">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-primary-foreground bg-primary rounded hover:bg-primary/90 transition-colors cursor-pointer flex-shrink-0 ml-2"
              >
              ...
              {creating ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 text-xs font-medium text-primary-foreground bg-primary rounded hover:bg-primary/90 disabled:opacity-50 transition-colors cursor-pointer"
                  >
                    {createLoading ? (
